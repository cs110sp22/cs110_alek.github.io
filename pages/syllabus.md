...
3. To help you to gauge what you know and don't know, so that you can make a plan to attend office hours.
...
We have 8 peer mentors (undergraduates) and one graduate TA to help you:

### Peer Mentors

Note that if you want to contact any PMs via email, you should place the email suffix
`u.northwestern.edu` after the email prefix.

| Name               | Email Prefix          |
| ------------------ | --------------------- |
| Vivian Chang       | VivianChang2029       |
| Natasha Dhanrajani | NatashaDhanrajani2026 |
| Tahmid Khan        | TahmidKhan2026        |
| Jacob Liang        | JacobLiang2027        |
| Ananya Rajgirish   | AnanyaRajgirish2027   |
| Shivam Sheth       | ShivamSheth2027       |
| Carley Sarah       | SarahCarley2026       |
| Amp Kangsumrith    | AmpKangsumrith2027    |

### Graduate Teaching Assistants

- Yibo Wen (YiboWen2024@`<nu_email_suffix>`)
...
> If you are struggling to get Python and your code editor installed, this is (alas) **_normal_** (ask any software engineer). This is also one of the reasons why we have such a big course staff: to troubleshoot individual laptop problems with students.
...
> - Keep your best 7 tutorial scores (best 7 of 8)
>
